...
<head>
    ...
    <a href="main.php">Retour au profil</a>
        ...
        <!-- Permet d'ajouter d'autres données que du texte -->
    ...
    <div id="content">
        <div id="modifications">
            ...
            <form method="post">
                ...
                <input type="text" name="ville" placeholder="Ex : Marseille bébé"/><br/>

                <label for="login">Modifier l'école</label>
                <input type="text" name="ecole" placeholder="Ex : Hetic"/><br/>

                <label for="login">Modifier la specialité</label>
                <input type="text" name="specialite" placeholder="Ex : Développement web"/><br/>
